...
!developmentChains.includes(network.name)
    ...
    : describe("Nft Marketplace Unit Tests", function () {
          ...
          beforeEach(async () => {
              ...
              // nftMarketplace = await ethers.getContract("NftMarketplace") -> we could just do this line instead of doing both of the lines, it defaults to deploy on account[0].
              // Writing it with both lines just makes it more explicit as to who is the deployer
